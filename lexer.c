		...
		switch(state)
		{
			...
			case 33:				
				switch(c) {
					...
					default:
						t->tokenType = TK_ERROR;
						t->lexeme = "expecting alphabet after underscore for function name";
						bufIndex -= 2;						
						return;
				}
				break;
			...
			case 37:
				switch(c) {
					...
					default:
						t->tokenType = TK_ERROR;
						t->lexeme = "expecting alphanumeral for function name";
						bufIndex -= 3;						
						return;
				}
				break;
			...
			case 42:
				switch(c) {
					...
					default:
						t->tokenType = TK_ERROR;
						t->lexeme = "expecting [a-z] for RUID";
						bufIndex -= 2;						
						return;
				}
				break;
